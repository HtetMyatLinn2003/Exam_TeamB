            ...
            <form method="post" action="SubjectCreateExecute.action">
                <div class="mx-4" style="max-width: 500px;">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="cd" name="cd" value="${cd}" maxlength="3" required />
                        <div class="text-danger small">${errors.get("cd")}</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="name">科目名</label>
                        <input class="form-control" type="text" id="name" name="name" value="${name}" maxlength="50" required />
