...
<ul class="nav nav-pills flex-column mb-auto px-4">
	...
	<li class="nav-item mb-1">成績管理</li>
	<li class="nav-item mx-3 mb-2"><a href="TestRegist.action">成績登録</a></li>
	<li class="nav-item mx-3 mb-2"><a href="TestList.action">成績参照</a></li>
