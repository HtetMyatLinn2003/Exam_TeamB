            ...
            <form method="post" action="StudentCreateExecute.action">
                <div class="mx-4" style="max-width: 500px;">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="no" name="no" value="${no}" maxlength="20" placeholder="学生番号を入力してください" />
                        <div class="text-danger small">${errors.get("no")}</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="name">氏名</label>
                        <input class="form-control" type="text" id="name" name="name" value="${name}" maxlength="50" placeholder="氏名を入力してください" />
